...
INSERT INTO site_config (key, value) VALUES
  ...
  ('logo_url',          'null'),
  ('favicon_url',       'null'),
  ('phone',             '"+55 81 98593-1081"'),
  ('whatsapp',          '"5581985931081"'),
  ('email',             '"administracao@morejaimobiliaria.com.br"'),
  ('address',           '"Av. Engenheiro Domingos Ferreira 1920, sala 102, Recife/PE"'),
  ('instagram',         '"https://instagram.com/moreja.imobiliaria"'),
  ('facebook',          '""'),
  ('youtube',           '""'),
  ('linkedin',          '""'),
  ('creci',             '""'),
