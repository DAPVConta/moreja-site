          ...
          {(instagram || facebook || youtube || tiktok) && (
            <div className="mt-7">
              ...
              <div className="flex justify-center gap-3">
                ...
                <SocialLink href={tiktok} label={`TikTok da ${resolvedName}`} icon={<IconTiktok />} className={socialIconClassActive} />
              </div>
            </div>
          )}
            ...
            <div>
              ...
              {(instagram || facebook || youtube || tiktok) && (
                <div className="flex gap-3 mt-6">
                  ...
                  <SocialLink href={tiktok} label={`TikTok da ${resolvedName}`} icon={<IconTiktok />} className={socialIconClass} />
                </div>
              )}
            </div>
