...
export function PropertyCard({ property, priority = false }: PropertyCardProps) {
  ...
  return (
    <div className="property-card group block relative">
      {/* Botão Salvar no canto superior direito — fica acima do <Link> via z-index
          para não disparar a navegação ao clicar no heart. */}
